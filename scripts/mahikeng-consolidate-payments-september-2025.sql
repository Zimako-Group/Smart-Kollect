-- Update Consolidated Payments for Mahikeng tenant - September 2025 only

-- This script specifically updates the September 2025 payment data for the Mahikeng tenant
...
-- Update September 2025 consolidated payment for Mahikeng tenant
-- Setting September payment amount to 6536933.11
...
BEGIN
    ...
    IF updated_count = 0 THEN
        RAISE NOTICE 'No rows were updated. The September 2025 record may not exist for Mahikeng tenant.';
        ...
        SELECT 
            ...
            9 as month,
            2025 as year,
            'Sep 2025' as month_display,
            6536933.11 as amount
        FROM "tenants" t
        ...
        RAISE NOTICE 'Inserted new September 2025 record for Mahikeng tenant.';
    ELSE
        RAISE NOTICE 'Successfully updated % row(s) for September 2025 Mahikeng payments.', updated_count;
    END IF;
    
    -- Display the current September 2025 amount for verification
    ...
    RAISE NOTICE 'Current September 2025 payment amount for Mahikeng: %', current_amount;
END $$;
